...
class Sequence(Generic[T], Iterable[T]):
    ...
    def map(
        self, transform: Callable[..., U], return_exceptions: bool = ...
    ...
    @overload
    async def map_async(
        self, transform: Callable[[T, int], Awaitable[U]], return_exceptions: Literal[True]
    ) -> Sequence[Union[U, BaseException]]: ...
    @overload
    async def map_async(
        self,
    ...
    async def map_async(
        self, transform: Callable[..., Awaitable[U]], return_exceptions: bool = ...
    ):
        """
    ...
    @overload
    def first_not_none_of(
        self: Sequence[Optional[U]], transform: Callable[[Optional[U], int], Optional[U]]
    ) -> U: ...
    @overload
    def first_not_none_of(
    ...
    def first_not_none_of(
        self: Sequence[Optional[U]], transform: Optional[Callable[..., Optional[U]]] = ...
    ) -> U:
        """
    ...
    def first_or_default(
        self, predicate: Union[Callable[..., bool], U], default: Optional[U] = ...
    ) -> Union[T, U, None]:
        """
    ...
    def associate_by(
        self, key_selector: Callable[..., K], value_transform: Optional[Callable[[T], V]] = ...
    ...
    def associate_by_to(
        ...
        key_selector: Callable[[T], K],
        value_transform: Optional[Callable[[T], Any]] = ...,
    ) -> Dict[K, Any]:
        """
        Returns a [Dict] containing key-value Tuple provided by [transform] function
        applied to elements of the given Sequence.
    ...
    def element_at_or_else(
        self, index: int, default: Union[Callable[[int], T], T, None] = ...
    ) -> Optional[T]:
        """
        Returns the element at the specified [index] in the Sequence or the [default] value if the index is out of bounds.
    ...
    def max_or_default(
        self: Union[Sequence[int], Sequence[float]], default: Optional[V] = ...
    ...
    @overload
    def group_by_to(
        self, destination: Dict[K, List[T]], key_selector: Callable[[T, int, Sequence[T]], K]
    ) -> Dict[K, List[T]]: ...
    def group_by_to(
    ...
    def parallel_for_each(
        self, action: Callable[[T], None], max_workers: Optional[int] = ...
    ) -> None: ...
    @overload
    def parallel_for_each(
        self, action: Callable[[T, int], None], max_workers: Optional[int] = ...
    ) -> None: ...
    @overload
    def parallel_for_each(
        self, action: Callable[[T, int, Sequence[T]], None], max_workers: Optional[int] = ...
    ) -> None: ...
    def parallel_for_each(
        self, action: Callable[..., None], max_workers: Optional[int] = ...
    ) -> None:
        """
    ...
    def zip(
        self, other: Iterable[Any], transform: Optional[Callable[..., V]] = ...
    ) -> Sequence[Any]:
        """
    ...
    def unzip(
        ...
        transform: Union[Optional[Callable[..., Tuple[Any, Any]]], bool] = ...,
    ) -> Tuple[ListLike[U], ListLike[V]]:
        """
    ...
    def shuffled(
        self, seed: Union[Random, int, float, str, bytes, bytearray, None] = ...
    ) -> Sequence[T]:
        """
...
class SequenceProducer:
    ...
    def read_csv(self, filepath: str, header: Optional[int] = ...):
        """
        Reads and parses the input of a csv file.
